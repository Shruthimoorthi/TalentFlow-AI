function CandidateHeader({
  ...
  const titles = {
    ...
    resume: {
      title: 'My Resume',
      subtitle: 'Manage your resume and analyze it with AI.',
    },
    jobs: {
      title: 'Find Jobs',
      subtitle: 'Discover opportunities that match your profile.',
    },
    applications: {
      title: 'Applications',
    ...
    interviews: {
      title: 'Interviews',
      subtitle: 'View your upcoming interviews and meeting details.',
    },
    settings: {
  title: 'Settings',
  subtitle:
    'View your candidate profile information.',
},
  }
